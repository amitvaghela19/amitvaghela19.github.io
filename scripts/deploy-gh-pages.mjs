...
try {
  ...
  run('git add -A', work)
  run(
    'git -c user.name=amitvaghela19 -c user.email=amitvaghela19@gmail.com commit -m "Deploy site"',
    work,
  )
  run(
    'git remote add origin https://github.com/amitvaghela19/amitvaghela19.github.io.git',
    work,
  )
